<template>
  <div v-once class="component-label-recognizer">
    ...
    <canvas class="dlrRecognizer-cvs-drawarea" style="width:100%;height:100%;position:absolute;left:0;top:0;"></canvas>
    <div class="dlrRecognizer-cvs-scanarea" style="width:100%;height:100%;position:absolute;left:0;top:0;">
      <div class="dlrRecognizer-scanlight" style="display:none;width:100%;height:3%;position:absolute;animation:3s infinite dce-scanlight;border-radius:50%;box-shadow:0px 0px 2vw 1px #00e5ff;background:#fff;user-select:none;"></div>
    </div>
    ...
    <div class="dlrRecognizer-msg-poweredby" style="position:absolute;left:50%;bottom:10%;transform:translateX(-50%);">
...
.dlrRecognizer-scanlight {
  width: 100%;
  height: 3%;
  position: absolute;
  animation: 3s infinite dlrRecognizer-scanlight;
  border-radius: 50%;
...
@keyframes dlrRecognizer-scanlight {
  from {
    top: 0;
  }
  to {
